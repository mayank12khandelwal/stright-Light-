...
<td><?php if(substr($payload,0,16)=="524c593030303030"){$jkl=substr($nowpayload,32,8);}else{ $jkl=substr($nowpayload,16,8);} $jk=hexdec($jkl)/1000;echo "$jk"."kw/h";?></td>
</tr>
<tr>
<td ><?php echo "<h2>voltage</h2>" ;?> </td>
<td><?php if(substr($payload,0,16)=="524c593030303030"){$jk2=substr($nowpayload,48,8);}else{$jk2=substr($nowpayload,40,8);} $jk2=hexdec($jk2)/10;echo "$jk2"."V";?></td>
</tr>
<tr>
<td ><?php echo "<h2>Current</h2>" ;?></td>
<td><?php if(substr($payload,0,16)=="524c593030303030"){$jk3=substr($nowpayload,56,8);}else{$jk3=substr($nowpayload,48,8);} $jk3=hexdec($jk3)/1000;echo "$jk3"."Amp";?></td>
</tr>
<tr>
<td><?php echo "<h2>KW</h2>" ;?></td>
<td><?php if(substr($payload,0,16)=="524c593030303030"){$jk4=substr($nowpayload,64,8);}else{$jk4=substr($nowpayload,56,8);} $jk4=hexdec($jk4)/1000;echo "$jk4"."kw";?></td>
</tr>
<tr>
<td><?php echo "<h2>PF</h2>" ;?></td>
<td><?php if(substr($payload,0,16)=="524c593030303030"){$jk5=substr($nowpayload,72,8);}else{$jk5=substr($nowpayload,64,8);} $jk5=hexdec($jk5)/100;echo "$jk5";?></td>
</tr>
<tr>
<td><?php echo "<h2>friquency</h2>" ;?></td>
<td><?php if(substr($payload,0,16)=="524c593030303030"){$jk6=substr($nowpayload,80,8);}else{ $jk6=substr($nowpayload,72,8);} $jk6=hexdec($jk6)/100;echo "$jk6"."hz";?></td>
</tr>
<tr>
